                ...
                <form action="/transferfund.org"method="post">
                    <table class="table table-striped table-bordered table-hover">
                        <tr>
                            ...
                            <td class="value">
                                <input type="text" name="payeename" placeholder="Enter the Payee Name"required>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="value">
                                <input type="text" name="accnumber" placeholder="Enter the account number" required>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="value">
                                <input type="text" name="bankdetails" placeholder="Enter the Payee Bank Details" required>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="value">
                                <input type="text" name="amount"placeholder="Enter the Transfer amount" required>
                            </td>
                        </tr>
                    </table>
